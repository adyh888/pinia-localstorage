 ...
 */
export abstract class ClientWebSocket extends WebSocket {
  /**
   * Same as  but with an <code>handler</code> called when the operation completes
   */
  write(data: Buffer) : PromiseLike<void>;
   ...
   */
  connect(port: number, host: string, requestURI: string) : PromiseLike<WebSocket>;

  /**
   * Connect a WebSocket to the specified port, host and relative request URI
   */
  connect(port: number, host: string, requestURI: string, handler: ((res: AsyncResult<WebSocket>) => void) | Handler<AsyncResult<WebSocket>>) : void;

  /**
   * Connect a WebSocket with the specified options.
   */
  connect(options: WebSocketConnectOptions) : PromiseLike<WebSocket>;

  /**
   * Connect a WebSocket with the specified options.
   */
  connect(options: WebSocketConnectOptions, handler: ((res: AsyncResult<WebSocket>) => void) | Handler<AsyncResult<WebSocket>>) : void;

  /**
   * Connect this WebSocket to the host and relative request URI and default port.
   */
  connect(host: string, requestURI: string) : PromiseLike<WebSocket>;

  /**
   * Connect this WebSocket to the host and relative request URI and default port.
   */
  connect(host: string, requestURI: string, handler: ((res: AsyncResult<WebSocket>) => void) | Handler<AsyncResult<WebSocket>>) : void;

  /**
   * Connect this WebSocket at the relative request URI using the default host and port.
   */
  connect(requestURI: string) : PromiseLike<WebSocket>;

  /**
   * Connect this WebSocket at the relative request URI using the default host and port.
   */
  connect(requestURI: string, handler: ((res: AsyncResult<WebSocket>) => void) | Handler<AsyncResult<WebSocket>>) : void;

  /* override */ handler(handler: ((res: Buffer) => void) | Handler<Buffer> | null | undefined) : ClientWebSocket;

  /* override */ endHandler(endHandler: ((res: void) => void) | Handler<void> | null | undefined) : ClientWebSocket;

  /* override */ drainHandler(handler: ((res: void) => void) | Handler<void> | null | undefined) : ClientWebSocket;

  /* override */ closeHandler(handler: ((res: void) => void) | Handler<void> | null | undefined) : ClientWebSocket;

  /* override */ frameHandler(handler: ((res: WebSocketFrame) => void) | Handler<WebSocketFrame> | null | undefined) : ClientWebSocket;

  /* override */ textMessageHandler(handler: ((res: string) => void) | Handler<string> | null | undefined) : ClientWebSocket;

  /* override */ binaryMessageHandler(handler: ((res: Buffer) => void) | Handler<Buffer> | null | undefined) : ClientWebSocket;

  /* override */ pongHandler(handler: ((res: Buffer) => void) | Handler<Buffer> | null | undefined) : ClientWebSocket;

  /* override */ exceptionHandler(handler: ((res: Throwable) => void) | Handler<Throwable> | null | undefined) : ClientWebSocket;

  /* override */ writeFrame(frame: WebSocketFrame) : PromiseLike<void>;

  /* override */ writeFrame(frame: WebSocketFrame, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ClientWebSocket;

  /* override */ writeFinalTextFrame(text: string) : PromiseLike<void>;

  /* override */ writeFinalTextFrame(text: string, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ClientWebSocket;

  /* override */ writeFinalBinaryFrame(data: Buffer) : PromiseLike<void>;

  /* override */ writeFinalBinaryFrame(data: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ClientWebSocket;

  /* override */ writeBinaryMessage(data: Buffer) : PromiseLike<void>;

  /* override */ writeBinaryMessage(data: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ClientWebSocket;

  /* override */ writeTextMessage(text: string) : PromiseLike<void>;

  /* override */ writeTextMessage(text: string, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ClientWebSocket;

  /* override */ writePing(data: Buffer) : PromiseLike<void>;

  /* override */ writePing(data: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ClientWebSocket;

  /* override */ writePong(data: Buffer) : PromiseLike<void>;

  /* override */ writePong(data: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ClientWebSocket;
...
export abstract class Context {
  ...
  /**
   * Like {@link Context#executeBlocking} but using a callback.
   */
  executeBlocking<T>(blockingCodeHandler: any /* java.util.concurrent.Callable<T> */) : PromiseLike<T>;

  /**
   * Like {@link Context#executeBlocking} but using a callback.
   */
  executeBlocking<T>(blockingCodeHandler: any /* java.util.concurrent.Callable<T> */, resultHandler: ((res: AsyncResult<T>) => void) | Handler<AsyncResult<T>>) : void;

  /**
   * Like {@link Context#executeBlocking} but using a callback.
   */
  executeBlocking<T>(blockingCodeHandler: any /* java.util.concurrent.Callable<T> */, ordered: boolean) : PromiseLike<T>;

  /**
   * Like {@link Context#executeBlocking} but using a callback.
   */
  executeBlocking<T>(blockingCodeHandler: any /* java.util.concurrent.Callable<T> */, ordered: boolean, resultHandler: ((res: AsyncResult<T>) => void) | Handler<AsyncResult<T>>) : void;
}
 ...
 */
export abstract class HostAndPort {
  /**
   * Create an instance.
   */
  static create(host: string, port: number) : HostAndPort;
...
export abstract class HttpClient implements Measured {
   ...
   */
  updateSSLOptions(options: SSLOptions) : PromiseLike<boolean>;

  /**
   * Like {@link HttpClient#updateSSLOptions}  but supplying a handler that will be called when the update
   * happened (or has failed).
   */
  updateSSLOptions(options: SSLOptions, handler: ((res: AsyncResult<boolean>) => void) | Handler<AsyncResult<boolean>>) : void;

  /**
   * Like {@link HttpClient#updateSSLOptions}  but supplying a handler that will be called when the update
   * happened (or has failed).
   */
  updateSSLOptions(options: SSLOptions, force: boolean) : PromiseLike<boolean>;

  /**
   * Like {@link HttpClient#updateSSLOptions}  but supplying a handler that will be called when the update
   * happened (or has failed).
   */
  updateSSLOptions(options: SSLOptions, force: boolean, handler: ((res: AsyncResult<boolean>) => void) | Handler<AsyncResult<boolean>>) : void;
 ...
 */
export abstract class HttpClientBuilder {
  /**
   * Configure the client options.
   */
  with(options: HttpClientOptions) : HttpClientBuilder;

  /**
   * Configure the client with the given pool <code>options</code>.
   */
  with(options: PoolOptions) : HttpClientBuilder;

  /**
   * Set a connection handler for the client. This handler is called when a new connection is established.
   */
  withConnectHandler(handler: ((res: HttpConnection) => void) | Handler<HttpConnection>) : HttpClientBuilder;
   ...
   * The handler must return a <code>Future<HttpClientRequest></code> unsent so the client can further configure it and send it.
   */
  withRedirectHandler(handler: (arg: HttpClientResponse) => PromiseLike<RequestOptions>) : HttpClientBuilder;
...
export abstract class HttpClientRequest implements WriteStream<Buffer> {
   ...
   */
  authority(authority: HostAndPort) : HttpClientRequest;
   ...
   */
  traceOperation(op: string) : HttpClientRequest;
  ...
  redirectHandler(handler: (arg: HttpClientResponse) => PromiseLike<HttpClientRequest> | null | undefined) : HttpClientRequest;
  ...
  /**
   * Like {@link HttpClientRequest#idleTimeout} but with a confusing name (hence the deprecation).
   */
  setTimeout(timeout: number) : HttpClientRequest;
   ...
   */
  idleTimeout(timeout: number) : HttpClientRequest;
...
export abstract class HttpServerResponse implements WriteStream<Buffer> {
  ...
  /**
   * Same as {@link HttpServerResponse#push} but with an <code>handler</code> called when the operation completes
   */
  push(method: HttpMethod, authority: HostAndPort, path: string, headers: MultiMap) : PromiseLike<HttpServerResponse>;
...
export abstract class MessageProducer<T> {
   ...
   *
   * The <code>handler</code> completion depends on the producer type:
   *
   * <ul>
   ...
   * </ul>
   *
   * In any case, a successfully completed <code>handler</code> is not a delivery guarantee.
   */
...
export abstract class ServerWebSocket implements WebSocketBase {
  ...
  /* override */ writePing(data: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ServerWebSocket;

  /* override */ writePong(data: Buffer) : PromiseLike<void>;

  /* override */ writePong(data: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : ServerWebSocket;
...
export abstract class Timer {
   ...
   * failed with a CancellationException.
   */
  cancel() : boolean;
}
...
export abstract class Vertx implements Measured {
   ...
   * <p>
   * Example usage: <code>HttpClient client = vertx.httpClientBuilder().with(options).withConnectHandler(conn -> ...).build()</code>
   */
   ...
   */
  createHttpClient(clientOptions: HttpClientOptions, poolOptions: PoolOptions) : HttpClient;

  /**
   * Create a HTTP/HTTPS client using the specified client options
   */
  createHttpClient(clientOptions: HttpClientOptions) : HttpClient;

  /**
   * Create a HTTP/HTTPS client using the specified pool options
   */
  createHttpClient(poolOptions: PoolOptions) : HttpClient;
  ...
  /**
   * Like {@link Vertx#timer} with a unit in millis.
   */
  timer(delay: number) : Timer;

  /**
   * Create a timer task configured with the specified <code>delay</code>, when the timeout fires the timer future
   * is succeeded, when the timeout is cancelled the timer future is failed with a CancellationException
   * instance.
   */
  timer(delay: number, unit: any) : Timer;
  ...
  /**
   * Like {@link Vertx#executeBlocking} but using a callback.
   */
  executeBlocking<T>(blockingCodeHandler: any /* java.util.concurrent.Callable<T> */) : PromiseLike<T>;
 ...
 * </code></pre>
 */
export abstract class VertxBuilder {
  /**
   * Configure the Vert.x options.
   */
  with(options: VertxOptions) : VertxBuilder;
   ...
   */
  buildClustered() : PromiseLike<Vertx>;
   ...
   * The instance is created asynchronously and the returned future is completed with the result when it is ready.
   */
  buildClustered(handler: ((res: AsyncResult<Vertx>) => void) | Handler<AsyncResult<Vertx>>) : void;
   ...
   */
  withMetrics(factory: any /* io.vertx.core.spi.VertxMetricsFactory */) : VertxBuilder;
   ...
   * programmatically you can use this method.
   */
  withTracer(factory: any /* io.vertx.core.spi.VertxTracerFactory */) : VertxBuilder;
   ...
   * programmatically you can use this method.
   */
  withClusterManager(clusterManager: any /* io.vertx.core.spi.cluster.ClusterManager */) : VertxBuilder;
}
...
export abstract class WebSocket implements WebSocketBase {
  ...
  /* override */ writePing(data: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : WebSocket;

  /* override */ writePong(data: Buffer) : PromiseLike<void>;

  /* override */ writePong(data: Buffer, handler: ((res: AsyncResult<void>) => void) | Handler<AsyncResult<void>>) : WebSocket;
 ...
 * <p>
 */
export abstract class WebSocketClient implements Measured {
  /**
   * Whether the metrics are enabled for this measured object
   */
  isMetricsEnabled() : boolean;
  ...
  /**
   * Like {@link WebSocketClient#updateSSLOptions}  but supplying a handler that will be called when the update
   * happened (or has failed).
   */
  updateSSLOptions(options: SSLOptions) : PromiseLike<boolean>;
...
export abstract class WorkerExecutor implements Measured {
  ...
  /**
   * Like {@link WorkerExecutor#executeBlocking} but using a callback.
   */
  executeBlocking<T>(blockingCodeHandler: any /* java.util.concurrent.Callable<T> */) : PromiseLike<T>;
