...
export class AddressResolverOptions {
  ...
  /**
   * Set the hosts configuration refresh period in millis, <code>0</code> disables it.
   * <p/>
   * The resolver caches the hosts configuration <a href="../../dataobjects.html#AddressResolverOptions">#hostsPath file</a> after it has read it. When
   ...
   * file again when necessary.
   */
  setHostsRefreshPeriod(hostsRefreshPeriod: number): AddressResolverOptions;
...
import { ThreadingModel } from './enums';
...
export class DeploymentOptions {
   ...
   */
  getThreadingModel(): ThreadingModel;

  /**
   * Set the verticle(s) verticle(s) threading model, e.g. a worker or a virtual thread verticle
   */
  setThreadingModel(threadingModel: ThreadingModel): DeploymentOptions;
...
export class HttpClientOptions extends ClientOptionsBase {
  ...
  /**
   * Whether the client should send requests with an <code>accepting-encoding</code> header set to a compression algorithm.
   */
   ...
   * Whether the client should send requests with an <code>accepting-encoding</code> header set to a compression algorithm.
   */
  setDecompressionSupported(decompressionSupported: boolean): HttpClientOptions;
   ...
   */
  getTryUsePerFrameWebSocketCompression(): boolean;
...
export class HttpServerOptions extends NetServerOptions {
   ...
   */
  isHttp2ClearTextEnabled(): boolean;

  /**
   * Set whether HTTP/2 over clear text is enabled or disabled, default is enabled.
   */
  setHttp2ClearTextEnabled(http2ClearTextEnabled: boolean): HttpServerOptions;
   ...
   * attacks. The default value is <a href="../../dataobjects.html#HttpServerOptions">HttpServerOptions</a>, setting zero or a negative value, disables flood protection.
   */
  getHttp2RstFloodMaxRstFramePerWindow(): number;

  /**
   * Set the max number of RST frame allowed per time window, this is used to prevent HTTP/2 RST frame flood DDOS
   * attacks. The default value is <a href="../../dataobjects.html#HttpServerOptions">HttpServerOptions</a>, setting zero or a negative value, disables flood protection.
   */
  setHttp2RstFloodMaxRstFramePerWindow(http2RstFloodMaxRstFramePerWindow: number): HttpServerOptions;
   ...
   * attacks. The default value is <a href="../../dataobjects.html#HttpServerOptions">HttpServerOptions</a>, setting zero or a negative value, disables flood protection.
   */
  getHttp2RstFloodWindowDuration(): number;

  /**
   * Set the duration of the time window when checking the max number of RST frames, this is used to prevent HTTP/2 RST frame flood DDOS
   * attacks. The default value is <a href="../../dataobjects.html#HttpServerOptions">HttpServerOptions</a>, setting zero or a negative value, disables flood protection.
   */
  setHttp2RstFloodWindowDuration(http2RstFloodWindowDuration: number): HttpServerOptions;

  /**
   * Set the time unit of the duration of the time window when checking the max number of RST frames, this is used to
   * prevent HTTP/2 RST frame flood DDOS attacks. The default value is <a href="../../dataobjects.html#HttpServerOptions">HttpServerOptions</a>,
   * setting zero or a negative value, disables the flood protection.
   */
  getHttp2RstFloodWindowDurationTimeUnit(): any;
   ...
   * setting zero or a negative value, disables the flood protection.
   */
  setHttp2RstFloodWindowDurationTimeUnit(http2RstFloodWindowDurationTimeUnit: any): HttpServerOptions;
   ...
   */
  /* override */ getTrafficShapingOptions(): TrafficShapingOptions;

  /**
   * Set traffic shaping options. If not specified, traffic is unthrottled.
   */
  /* override */ setTrafficShapingOptions(trafficShapingOptions: TrafficShapingOptions): HttpServerOptions;
...
export class NetServerOptions extends TCPSSLOptions {
   ...
   * Set traffic shaping options. If not specified, traffic is unthrottled.
   */
  getTrafficShapingOptions(): TrafficShapingOptions;

  /**
   * Set traffic shaping options. If not specified, traffic is unthrottled.
   */
  setTrafficShapingOptions(trafficShapingOptions: TrafficShapingOptions): NetServerOptions;
...
export class PoolOptions {
   ...
   * will remain in the pool until they are closed.
   */
  getCleanerPeriod(): number;

  /**
   * Set the connection pool cleaner period in milli seconds, a non positive value disables expiration checks and connections
   * will remain in the pool until they are closed.
   */
  setCleanerPeriod(cleanerPeriod: number): PoolOptions;
   ...
   */
  getHttp1MaxSize(): number;

  /**
   * Set the maximum pool size for HTTP/1.x connections
   */
  setHttp1MaxSize(http1MaxSize: number): PoolOptions;

  /**
   * Set the maximum pool size for HTTP/2 connections
   */
  getHttp2MaxSize(): number;

  /**
   * Set the maximum pool size for HTTP/2 connections
   */
  setHttp2MaxSize(http2MaxSize: number): PoolOptions;
...
export class RequestOptions {
   ...
   * the <code>Future<HttpClientRequest></code> obtained from the client is failed with a TimeoutException.
   *
   * Note this is not related to the TCP <a href="../../dataobjects.html#HttpClientOptions">HttpClientOptions</a> option, when a request is made against
   ...
   * might fire because the server does not respond in time or the pool is too busy to serve a request.
   */
  setConnectTimeout(connectTimeout: number): RequestOptions;
   ...
   * {@link HttpClientRequest#idleTimeout}.
   */
   ...
   * {@link HttpClientRequest#idleTimeout}.
   */
  setIdleTimeout(idleTimeout: number): RequestOptions;
   ...
   *
   * <ul>
   *   <li><i>connect timeout</i>: if the request is not obtained from the client within the timeout period, the <code>Future<HttpClientRequest></code>
   *   obtained from the client is failed with a TimeoutException.</li>
   ...
   *   related futures are failed with a TimeoutException, e.g. <code>Future<HttpClientResponse></code>
   *   or <code>Future<Buffer></code> response body.</li>
   * </ul>
   *
   * The connect and idle timeouts can be set separately using <a href="../../dataobjects.html#RequestOptions">RequestOptions</a> and <a href="../../dataobjects.html#RequestOptions">RequestOptions</a>
   */
  getTimeout(): number;
 ...
 */
export class TrafficShapingOptions {

  constructor();

  constructor(obj: TrafficShapingOptions | { [key: string]: any });

  /**
   * Set the delay between two computations of performances for channels or 0 if no stats are to be computed
   */
  getCheckIntervalForStats(): number;

  /**
   * Set the delay between two computations of performances for channels or 0 if no stats are to be computed
   */
  setCheckIntervalForStats(checkIntervalForStats: number): TrafficShapingOptions;

  /**
   * Set time unit for check interval for stats.
   */
  getCheckIntervalForStatsTimeUnit(): any;

  /**
   * Set time unit for check interval for stats.
   */
  setCheckIntervalForStatsTimeUnit(checkIntervalForStatsTimeUnit: any): TrafficShapingOptions;

  /**
   * Set bandwidth limit in bytes per second for inbound connections
   */
  getInboundGlobalBandwidth(): number;

  /**
   * Set bandwidth limit in bytes per second for inbound connections
   */
  setInboundGlobalBandwidth(inboundGlobalBandwidth: number): TrafficShapingOptions;

  /**
   * Set the maximum delay to wait in case of traffic excess
   */
  getMaxDelayToWait(): number;

  /**
   * Set the maximum delay to wait in case of traffic excess
   */
  setMaxDelayToWait(maxDelayToWait: number): TrafficShapingOptions;

  /**
   */
  getMaxDelayToWaitTimeUnit(): any;

  /**
   * Set the maximum delay to wait time unit
   */
  setMaxDelayToWaitUnit(maxDelayToWaitUnit: any): TrafficShapingOptions;

  /**
   * Set bandwidth limit in bytes per second for outbound connections
   */
  getOutboundGlobalBandwidth(): number;

  /**
   * Set bandwidth limit in bytes per second for outbound connections
   */
  setOutboundGlobalBandwidth(outboundGlobalBandwidth: number): TrafficShapingOptions;
   ...
   */
  getPeakOutboundGlobalBandwidth(): number;

  /**
   * Set the maximum global write size in bytes per second allowed in the buffer globally for all channels before write
   * suspended is set. Default value is 400 MB
   */
  setPeakOutboundGlobalBandwidth(peakOutboundGlobalBandwidth: number): TrafficShapingOptions;
...
export class WebSocketClientOptions extends ClientOptionsBase {

  constructor();

  constructor(obj: WebSocketClientOptions | { [key: string]: any });
   ...
   * Set the value of Netty's logging handler's data format: Netty's pipeline is configured for logging on Netty's logger.
   */
  /* override */ setActivityLogDataFormat(activityLogDataFormat: any): WebSocketClientOptions;
   ...
   * <p> Set to a negative value to disable it.
   */
  setClosingTimeout(closingTimeout: number): WebSocketClientOptions;

  /**
   * Set whether the <code>client_no_context_takeover</code> parameter of the WebSocket per-message
   * deflate compression extension will be offered.
   */
  getCompressionAllowClientNoContext(): boolean;

  /**
   * Set whether the <code>client_no_context_takeover</code> parameter of the WebSocket per-message
   * deflate compression extension will be offered.
   */
  setCompressionAllowClientNoContext(compressionAllowClientNoContext: boolean): WebSocketClientOptions;
   ...
   * Set the WebSocket deflate compression level.
   */
  setCompressionLevel(compressionLevel: number): WebSocketClientOptions;

  /**
   * Set whether the <code>server_no_context_takeover</code> parameter of the WebSocket per-message
   * deflate compression extension will be offered.
   */
  getCompressionRequestServerNoContext(): boolean;

  /**
   * Set whether the <code>server_no_context_takeover</code> parameter of the WebSocket per-message
   * deflate compression extension will be offered.
   */
  setCompressionRequestServerNoContext(compressionRequestServerNoContext: boolean): WebSocketClientOptions;
   ...
   * Set the connect timeout
   */
  /* override */ setConnectTimeout(connectTimeout: number): WebSocketClientOptions;
   ...
   * Add a CRL path
   */
  /* override */ addCrlPath(crlPaths: string): WebSocketClientOptions;
   ...
   * Add a CRL value
   */
  /* override */ addCrlValue(crlValues: Buffer): WebSocketClientOptions;
   ...
   * Set the default host name to be used by this client in requests if none is provided when making the request.
   */
  setDefaultHost(defaultHost: string): WebSocketClientOptions;
   ...
   * Set the default port to be used by this client in requests if none is provided when making the request.
   */
  setDefaultPort(defaultPort: number): WebSocketClientOptions;
   ...
   * Add an enabled cipher suite, appended to the ordered suites.
   */
  /* override */ addEnabledCipherSuite(enabledCipherSuites: string): WebSocketClientOptions;
   ...
   * Sets the list of enabled SSL/TLS protocols.
   */
  /* override */ setEnabledSecureTransportProtocols(enabledSecureTransportProtocols: string[]): WebSocketClientOptions;

  /**
   * Sets the list of enabled SSL/TLS protocols.
   */
  /* override */ addEnabledSecureTransportProtocol(enabledSecureTransportProtocols: string): WebSocketClientOptions;

  /**
   * Set the idle timeout, default time unit is seconds. Zero means don't timeout.
   * This determines if a connection will timeout and be closed if no data is received nor sent within the timeout.
   *
   * If you want change default time unit, use <a href="../../dataobjects.html#WebSocketClientOptions">WebSocketClientOptions</a>
   */
  /* override */ getIdleTimeout(): number;
   ...
   * If you want change default time unit, use <a href="../../dataobjects.html#WebSocketClientOptions">WebSocketClientOptions</a>
   */
  /* override */ setIdleTimeout(idleTimeout: number): WebSocketClientOptions;
   ...
   * Set the idle timeout unit. If not specified, default is seconds.
   */
  /* override */ setIdleTimeoutUnit(idleTimeoutUnit: any): WebSocketClientOptions;
  ...
  /**
   */
  /* override */ setJdkSslEngineOptions(jdkSslEngineOptions: JdkSSLEngineOptions): WebSocketClientOptions;

  /**
   * Set the key/cert options.
   */
  /* override */ setKeyCertOptions(keyCertOptions: KeyCertOptions): WebSocketClientOptions;
   ...
   * Set the key/cert options in jks format, aka Java keystore.
   */
  /* override */ setKeyStoreOptions(keyStoreOptions: JksOptions): WebSocketClientOptions;
   ...
   * it will pick any local address, the default local address is null.
   */
  /* override */ setLocalAddress(localAddress: string): WebSocketClientOptions;
   ...
   * Set to true to enabled network activity logging: Netty's pipeline is configured for logging on Netty's logger.
   */
  /* override */ setLogActivity(logActivity: boolean): WebSocketClientOptions;
   ...
   * Set the max number of WebSockets per endpoint.
   */
  setMaxConnections(maxConnections: number): WebSocketClientOptions;
   ...
   * Set the max WebSocket frame size
   */
  setMaxFrameSize(maxFrameSize: number): WebSocketClientOptions;
   ...
   * Set the max WebSocket message size
   */
  setMaxMessageSize(maxMessageSize: number): WebSocketClientOptions;
   ...
   * with the same name.
   */
  /* override */ setMetricsName(metricsName: string): WebSocketClientOptions;
   ...
   * Set the client name, used when the client is shared, otherwise ignored.
   */
  setName(name: string): WebSocketClientOptions;
   ...
   * <i>www.example.com</i>.
   */
  /* override */ setNonProxyHosts(nonProxyHosts: string[]): WebSocketClientOptions;
   ...
   * <i>www.example.com</i>.
   */
  /* override */ addNonProxyHost(nonProxyHosts: string): WebSocketClientOptions;
  ...
  /**
   */
  /* override */ setOpenSslEngineOptions(openSslEngineOptions: OpenSSLEngineOptions): WebSocketClientOptions;
   ...
   * Set the key/cert store options in pem format.
   */
  /* override */ setPemKeyCertOptions(pemKeyCertOptions: PemKeyCertOptions): WebSocketClientOptions;
   ...
   * Set the trust options in pem format
   */
  /* override */ setPemTrustOptions(pemTrustOptions: PemTrustOptions): WebSocketClientOptions;
   ...
   * Set the key/cert options in pfx format.
   */
  /* override */ setPfxKeyCertOptions(pfxKeyCertOptions: PfxOptions): WebSocketClientOptions;
   ...
   * Set the trust options in pfx format
   */
  /* override */ setPfxTrustOptions(pfxTrustOptions: PfxOptions): WebSocketClientOptions;

  /**
   * Set proxy options for connections via CONNECT proxy (e.g. Squid) or a SOCKS proxy.
   */
  /* override */ getProxyOptions(): ProxyOptions;

  /**
   * Set proxy options for connections via CONNECT proxy (e.g. Squid) or a SOCKS proxy.
   */
  /* override */ setProxyOptions(proxyOptions: ProxyOptions): WebSocketClientOptions;
   ...
   * If you want change default time unit, use <a href="../../dataobjects.html#WebSocketClientOptions">WebSocketClientOptions</a>
   */
  /* override */ setReadIdleTimeout(readIdleTimeout: number): WebSocketClientOptions;
   ...
   * Set the TCP receive buffer size
   */
  /* override */ setReceiveBufferSize(receiveBufferSize: number): WebSocketClientOptions;
   ...
   * Set the value of reuse address
   */
  /* override */ setReuseAddress(reuseAddress: boolean): WebSocketClientOptions;
   ...
   * This is only supported by native transports.
   */
  /* override */ setReusePort(reusePort: boolean): WebSocketClientOptions;
   ...
   * Set the TCP send buffer size
   */
  /* override */ setSendBufferSize(sendBufferSize: number): WebSocketClientOptions;
   ...
   * It's <code>false</code> as default.
   */
  setSendUnmaskedFrames(sendUnmaskedFrames: boolean): WebSocketClientOptions;

  /**
   * Set to <code>true</code> to share the client.
   *
   * <p> There can be multiple shared clients distinguished by <a href="../../dataobjects.html#WebSocketClientOptions">WebSocketClientOptions</a>, when no specific
   * name is set, the <a href="../../dataobjects.html#HttpClientOptions">HttpClientOptions</a> is used.
   */
  isShared(): boolean;
   ...
   * name is set, the <a href="../../dataobjects.html#HttpClientOptions">HttpClientOptions</a> is used.
   */
  setShared(shared: boolean): WebSocketClientOptions;
   ...
   * Set whether SO_linger keep alive is enabled
   */
  /* override */ setSoLinger(soLinger: number): WebSocketClientOptions;
   ...
   * Set whether SSL/TLS is enabled
   */
  /* override */ setSsl(ssl: boolean): WebSocketClientOptions;
   ...
   * Set to use SSL engine implementation to use.
   */
  /* override */ setSslEngineOptions(sslEngineOptions: SSLEngineOptions): WebSocketClientOptions;
   ...
   * Set the SSL handshake timeout, default time unit is seconds.
   */
  /* override */ setSslHandshakeTimeout(sslHandshakeTimeout: number): WebSocketClientOptions;
   ...
   * Set the SSL handshake timeout unit. If not specified, default is seconds.
   */
  /* override */ setSslHandshakeTimeoutUnit(sslHandshakeTimeoutUnit: any): WebSocketClientOptions;
   ...
   * Enable the <code>TCP_CORK</code> option - only with linux native transport.
   */
  /* override */ setTcpCork(tcpCork: boolean): WebSocketClientOptions;
   ...
   * Enable the <code>TCP_FASTOPEN</code> option - only with linux native transport.
   */
  /* override */ setTcpFastOpen(tcpFastOpen: boolean): WebSocketClientOptions;
   ...
   * Set whether TCP keep alive is enabled
   */
  /* override */ setTcpKeepAlive(tcpKeepAlive: boolean): WebSocketClientOptions;
   ...
   * Set whether TCP no delay is enabled
   */
  /* override */ setTcpNoDelay(tcpNoDelay: boolean): WebSocketClientOptions;
   ...
   * Enable the <code>TCP_QUICKACK</code> option - only with linux native transport.
   */
  /* override */ setTcpQuickAck(tcpQuickAck: boolean): WebSocketClientOptions;
   ...
   * Sets the <code>TCP_USER_TIMEOUT</code> option - only with linux native transport.
   */
  /* override */ setTcpUserTimeout(tcpUserTimeout: number): WebSocketClientOptions;
   ...
   * Set the value of traffic class
   */
  /* override */ setTrafficClass(trafficClass: number): WebSocketClientOptions;
   ...
   * Set whether all server certificates should be trusted
   */
  /* override */ setTrustAll(trustAll: boolean): WebSocketClientOptions;
   ...
   * Set the trust options.
   */
  /* override */ setTrustOptions(trustOptions: TrustOptions): WebSocketClientOptions;
   ...
   * Set the trust options in jks format, aka Java truststore
   */
  /* override */ setTrustStoreOptions(trustStoreOptions: JksOptions): WebSocketClientOptions;

  /**
   * Set whether the client will offer the WebSocket per-frame deflate compression extension.
   */
  getTryUsePerFrameCompression(): boolean;

  /**
   * Set whether the client will offer the WebSocket per-frame deflate compression extension.
   */
  setTryUsePerFrameCompression(tryUsePerFrameCompression: boolean): WebSocketClientOptions;

  /**
   * Set whether the client will offer the WebSocket per-message deflate compression extension.
   */
  getTryUsePerMessageCompression(): boolean;

  /**
   * Set whether the client will offer the WebSocket per-message deflate compression extension.
   */
  setTryUsePerMessageCompression(tryUsePerMessageCompression: boolean): WebSocketClientOptions;
   ...
   * Set the ALPN usage.
   */
  /* override */ setUseAlpn(useAlpn: boolean): WebSocketClientOptions;
   ...
   * Set whether hostname verification is enabled
   */
  setVerifyHost(verifyHost: boolean): WebSocketClientOptions;
   ...
   * If you want change default time unit, use <a href="../../dataobjects.html#WebSocketClientOptions">WebSocketClientOptions</a>
   */
  /* override */ setWriteIdleTimeout(writeIdleTimeout: number): WebSocketClientOptions;
...
export class WebSocketConnectOptions extends RequestOptions {
  ...
  /**
   * Like <a href="../../dataobjects.html#WebSocketConnectOptions">WebSocketConnectOptions</a> but using an  parameter.
   */
  /* override */ setAbsoluteURI(absoluteURI: any /* java.net.URL */): WebSocketConnectOptions;
   ...
   * might fire because the server does not respond in time or the pool is too busy to serve a request.
   */
  /* override */ setConnectTimeout(connectTimeout: number): WebSocketConnectOptions;

  /**
   * Set whether to follow HTTP redirect
   */
  /* override */ getFollowRedirects(): boolean;

  /**
   * Set whether to follow HTTP redirect
   */
  /* override */ setFollowRedirects(followRedirects: boolean): WebSocketConnectOptions;
   ...
   *  will be passed to the exception handler and the connection will be closed.
   */
  /* override */ setIdleTimeout(idleTimeout: number): WebSocketConnectOptions;

  /**
   * Set the HTTP method to be used by the client request.
   */
  /* override */ setMethod(method: HttpMethod): WebSocketConnectOptions;
   ...
   * <p> Use this when you want to connect to a specific server address without name resolution.
   */
  /* override */ getServer(): SocketAddress;
   ...
   * <p> Use this when you want to connect to a specific server address without name resolution.
   */
  /* override */ setServer(server: SocketAddress): WebSocketConnectOptions;
   ...
   * instead.
   */
  /* override */ getTraceOperation(): string;

  /**
   * Override the operation the tracer use for this request. When no operation is set, the HTTP method is used
   * instead.
   */
  /* override */ setTraceOperation(traceOperation: string): WebSocketConnectOptions;
