...
export declare function Uc(service: any, isDebugMode?: boolean, isAesToStr?: boolean): {
    ...
    roleToolAccessBatchDelete: (params: RoleToolAccessBatchDeleteProperty) => Promise<any>;
    deviceInfoGroupByType: (params: {
        uid: number;
    }) => Promise<any>;
    userToolInsertBatch: (params: UserToolInsertBatchProperty) => Promise<any>;
    doFirstLoginCard: (params: {
        cardNo: string;
        deviceId: string;
    }) => Promise<any>;
