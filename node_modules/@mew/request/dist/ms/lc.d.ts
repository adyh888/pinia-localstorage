...
export declare function Lc(service: any, isDebugMode?: boolean, isAesToStr?: boolean): {
    ...
    log_process_main: Request<LogProcessMain, LogProcessMainInsertProperty, LogProcessMainDeleteProperty, LogProcessMainUpdateProperty, LogProcessMainSelectProperty>;
    log_evaluation: Request<LogEvaluation, LogEvaluationInsertProperty, LogEvaluationDeleteProperty, LogEvaluationUpdateProperty, LogEvaluationSelectProperty>;
    log_error: Request<LogError, LogErrorInsertProperty, LogErrorDeleteProperty, LogErrorUpdateProperty, LogErrorSelectProperty>;
    log_ssh: Request<LogSsh, LogSshInsertProperty, LogSshDeleteProperty, LogSshUpdateProperty, LogSshSelectProperty>;
    log_table_modify: Request<LogTableModify, LogTableModifyInsertProperty, LogTableModifyDeleteProperty, LogTableModifyUpdateProperty, LogTableModifySelectProperty>;
    ...
    logProcessStatistics: (params: LogProcessSelectProperty) => Promise<any>;
    logProcessViewSelect: (params: LogProcessSelectProperty) => Promise<any>;
    logInsertBatch: (params: logInsertBatchParamType) => Promise<any>;
    logInsertBatch2: (params: logInsertBatchParamType) => Promise<any>;
    logFeedbackGoods: (params: logSelectFeedbackGoodsParamType) => Promise<any>;
    logProcessComprehensiveFind: (params: LogProcessSelectProperty) => Promise<any>;
    logFeedbackUpdateBatch: (json: LogFeedbackUpdateBatchProperty) => Promise<any>;
    ...
    getUsageTimes: (json: TopTenUsageTimesProperty) => Promise<any>;
    logFixData: (json: any) => Promise<any>;
};
