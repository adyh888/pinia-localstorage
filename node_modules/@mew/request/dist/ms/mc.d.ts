...
export declare function Mc(service: any, isDebugMode?: boolean, isAesToStr?: boolean): {
    ...
    getAccessByRole: (json: RoleAccessSelectProperty) => Promise<any>;
    updateRoleAccessBatch: (json: RoleAccessUpdateBatchProperty) => Promise<IRes>;
    accessDirectExcelSave: (json: any) => Promise<IRes>;
    alipayTransfer: (json: AlipayTransferProperty) => Promise<any>;
};
