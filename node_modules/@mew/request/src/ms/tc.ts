...
export interface SuitTemplateItemSelectProperty
    extends SuitTemplateItemProperty {
    curPageNo?: number;
    pageSize?: number;
    startAt?: number;
    endAt?: number;
...
export interface SuitTemplateItemUpdateProperty
    extends SuitTemplateItemProperty {
    id: number;
}

export interface SuitTemplateItemInsertProperty
    extends SuitTemplateItemProperty {
    suitTemplateId: number;
    num: number;
    toolName: string;
...
export interface SuitTemplateItemDeleteProperty
    extends SuitTemplateItemProperty {
    idArr?: number[];
}
...
export interface ProductionProcessSelectProperty
    extends ProductionProcessProperty {
    curPageNo?: number;
    pageSize?: number;
    startAt?: number;
    endAt?: number;
...
export interface ProductionProcessUpdateProperty
    extends ProductionProcessProperty {
    id: number;
}

export interface ProductionProcessInsertProperty
    extends ProductionProcessProperty {
    name: string;
}

export interface ProductionProcessDeleteProperty
    extends ProductionProcessProperty {
    id?: number;
    idArr?: number[];
}
...
export interface ProductionProcessItemSelectProperty
    extends ProductionProcessItemProperty {
    curPageNo?: number;
    pageSize?: number;
    startAt?: number;
    endAt?: number;
...
export interface ProductionProcessItemUpdateProperty
    extends ProductionProcessItemProperty {
    id: number;
}

export interface ProductionProcessItemInsertProperty
    extends ProductionProcessItemProperty {
    productionProcessId: number;
}

export interface ProductionProcessItemDeleteProperty
    extends ProductionProcessItemProperty {
    id?: number;
    idArr?: number[];
}
...
export function Tc(service: any, isDebugMode: boolean = false, isAesToStr = false) {
    return {
        type: new Request<Type,
            TypeInsertProperty,
            TypeDeleteProperty,
            TypeUpdateProperty,
            TypeSelectProperty>("/tc/type", service, isDebugMode, isAesToStr),
        specifications: new Request<Specifications,
            SpecificationsInsertProperty,
            SpecificationsDeleteProperty,
            SpecificationsUpdateProperty,
            SpecificationsSelectProperty>("/tc/specifications", service, isDebugMode, isAesToStr),
        item: new Request<Item,
            ItemInsertProperty,
            ItemDeleteProperty,
            ItemUpdateProperty,
            ItemSelectProperty>("/tc/item", service, isDebugMode, isAesToStr),
        suit: new Request<Suit,
            SuitInsertProperty,
            SuitDeleteProperty,
            SuitUpdateProperty,
            SuitSelectProperty>("/tc/suit", service, isDebugMode, isAesToStr),
        suit_template: new Request<SuitTemplate,
            SuitTemplateInsertProperty,
            SuitTemplateDeleteProperty,
            SuitTemplateUpdateProperty,
            SuitTemplateSelectProperty>("/tc/suit_template", service, isDebugMode, isAesToStr),
        suit_template_item: new Request<SuitTemplateItem,
            SuitTemplateItemInsertProperty,
            SuitTemplateItemDeleteProperty,
            SuitTemplateItemUpdateProperty,
            SuitTemplateItemSelectProperty>("/tc/suit_template_item", service, isDebugMode, isAesToStr),
        recycling_type: new Request<RecyclingType,
            RecyclingTypeInsertProperty,
            RecyclingTypeDeleteProperty,
            RecyclingTypeUpdateProperty,
            RecyclingTypeSelectProperty>("/tc/recycling_type", service, isDebugMode, isAesToStr),
        workorder_type: new Request<WorkorderType,
            WorkorderTypeInsertProperty,
            WorkorderTypeDeleteProperty,
            WorkorderTypeUpdateProperty,
            WorkorderTypeSelectProperty>("/tc/workorder_type", service, isDebugMode, isAesToStr),
        car_model: new Request<CarModel,
            CarModelInsertProperty,
            CarModelDeleteProperty,
            CarModelUpdateProperty,
            CarModelSelectProperty>("/tc/car_model", service, isDebugMode, isAesToStr),
        production_process: new Request<ProductionProcess,
            ProductionProcessInsertProperty,
            ProductionProcessDeleteProperty,
            ProductionProcessUpdateProperty,
            ProductionProcessSelectProperty>("/tc/production_process", service, isDebugMode, isAesToStr),
        production_process_item: new Request<ProductionProcessItem,
            ProductionProcessItemInsertProperty,
            ProductionProcessItemDeleteProperty,
            ProductionProcessItemUpdateProperty,
            ProductionProcessItemSelectProperty>("/tc/production_process_item", service, isDebugMode, isAesToStr),
        supplies: new Request<Supplies, SuppliesInsertProperty, SuppliesDeleteProperty, SuppliesUpdateProperty, SuppliesSelectProperty>('/tc/supplies', service, isDebugMode),
		organizational_inventory: new Request<OrganizationalInventory, OrganizationalInventoryInsertProperty, OrganizationalInventoryDeleteProperty, OrganizationalInventoryUpdateProperty, OrganizationalInventorySelectProperty>('/tc/organizational_inventory', service, isDebugMode),
        // class
        tool: new Request<Tool,
            ToolInsertProperty,
            ToolDeleteProperty,
            ToolUpdateProperty,
            ToolSelectProperty>("/tc/tool", service, isDebugMode, isAesToStr),
        rfid: new Request<Rfid,
            RfidInsertProperty,
            RfidDeleteProperty,
            RfidUpdateProperty,
            RfidSelectProperty>("/tc/rfid", service, isDebugMode, isAesToStr),
        rent: new Request<Rent,
            RentInsertProperty,
            RentDeleteProperty,
            RentUpdateProperty,
            RentSelectProperty>("/tc/rent", service, isDebugMode, isAesToStr),
        transfer: new Request<Transfer,
            TransferInsertProperty,
            TransferDeleteProperty,
            TransferUpdateProperty,
            TransferSelectProperty>("/tc/transfer", service, isDebugMode, isAesToStr),
        transfer_item: new Request<TransferItem,
            TransferItemInsertProperty,
            TransferItemDeleteProperty,
            TransferItemUpdateProperty,
            TransferItemSelectProperty>("/tc/transfer_item", service, isDebugMode, isAesToStr),
        workorder: new Request<WorkOrder,
            WorkOrderInsertProperty,
            WorkOrderDeleteProperty,
            WorkOrderUpdateProperty,
            WorkOrderSelectProperty>("/tc/workorder", service, isDebugMode, isAesToStr),
        workorder_item: new Request<WorkOrderItem,
            WorkOrderItemInsertProperty,
            WorkOrderItemDeleteProperty,
            WorkOrderItemUpdateProperty,
            WorkOrderItemSelectProperty>("/tc/workorder_item", service, isDebugMode, isAesToStr),
        bill: new Request<Bill,
            BillInsertProperty,
            BillDeleteProperty,
            BillUpdateProperty,
            BillSelectProperty>("/tc/bill", service, isDebugMode, isAesToStr),
        part: new Request<Part,
            PartInsertProperty,
            PartDeleteProperty,
            PartUpdateProperty,
            PartSelectProperty>("/tc/part", service, isDebugMode, isAesToStr),
        // function
        getVersion: (service: AxiosInstance) =>
            mewRequest("/gc/select/version", {}, "POST", service, isDebugMode, isAesToStr),
        insertTransferItemBatch: (service: AxiosInstance) =>
            async function (json: TransferItemInsertBatchProperty) {
                const res = await mewMsPost(
                    `/tc/transfer/insert/batch`,
                    json,
                    service,
                    isDebugMode,
                    isAesToStr
        ...
        insertToolBatch: async function (json: ToolInsertBatchProperty) {
            const res = await mewMsDelete(
                "/tc/tool/insert/batch",
                json,
                service,
                isDebugMode,
                isAesToStr
        ...
        chartData: async function (params: { type }) {
            return await mewMsPost(
                "/tc/workorder/chartData",
                params,
                service,
                isDebugMode,
                isAesToStr
        ...
        itemExportData: async function (params: ItemSelectProperty) {
            return await mewMsPost(
                "/tc/item/exportData",
                params,
                service,
        ...
        workorderPro: async (params: commonProperty) => {
            const res = await mewRequest(
                "/tc/workorder/workorderPro",
                params,
                "POST",
                service,
                isDebugMode,
        ...
        depPreInspectStatistics: async (params: commonProperty) => {
            const res = await mewRequest(
                "/tc/workorder/depPreInspectStatistics",
                params,
                "POST",
                service,
                isDebugMode,
        ...
        depPreInspectProByWeek: async (params: commonProperty) => {
            const res = await mewRequest(
                "/tc/workorder/depPreInspectProByWeek",
                params,
                "POST",
                service,
                isDebugMode,
        ...
        totalWorkorderNumAndOther: async (params: commonProperty) => {
            const res = await mewRequest(
                "/tc/workorder/totalWorkorderNumAndOther",
                params,
                "POST",
                service,
                isDebugMode,
        ...
        bindParentTool: async (params: BindParentToolProperty) => {
            ...
            return await mewRequest(
                "/tc/tool/bindParentTool",
                params,
                "POST",
                service,
                isDebugMode,
        ...
        //// 批量插入工单项
        workorderItemInsertBatch: async (
            params: WorkOrderItemInsertBatchProperty
        ) => {
            return await mewRequest(
                "/tc/workorder_item/insert/batch",
                params,
                "POST",
                service,
                isDebugMode,
        ...
        suitTemplateItemInsertBatch: async (
            params: SuitTemplateItemInsertBatchProperty
        ) => {
            return await mewRequest(
                "/tc/suit_template_item/insert/batch",
                params,
                "POST",
                service,
                isDebugMode,
        ...
        productionProcessItemInsertBatch: async (
            params: ProductionProcessItemInsertBatchSelectProperty
        ) => {
            return await mewRequest(
                "/tc/production_process_item/insert/batch",
                params,
                "POST",
                service,
                isDebugMode,
        ...
        productionProcessGenerateWorkorder: async (params: ProductionProcessGenerateWorkorderProperty) => {return await mewRequest("/tc/production_process/generateWorkorder", params, "POST", service, isDebugMode, isAesToStr);},
        rfidInsertBatchByEpcArr: async (params: RfidInsertBatchByEpcArrProperty) => {return await mewRequest("/tc/rfid/insert/batch/epcArr", params, "POST", service, isDebugMode, isAesToStr);},
        rfidBindTool: async (params: RfidBindToolProperty) => {return await mewRequest("/tc/rfid/bindTool", params, "POST", service, isDebugMode, isAesToStr);},
        rfidUnbindTool: async (params: RfidUnbindToolProperty) => {return await mewRequest("/tc/rfid/unbindTool", params, "POST", service, isDebugMode, isAesToStr);},
        suitGetCode: async (params: any) => {return await mewRequest("/tc/suit/getCode", params, "POST", service, isDebugMode, isAesToStr);},
        suitTemplateGetCode: async (params: any) => {return await mewRequest("/tc/suit_template/getCode", params, "POST", service, isDebugMode, isAesToStr);},
        generateToolByParentTool: async (params: any) => {return await mewRequest("/tc/tool/generateToolByParentTool", params, "POST", service, isDebugMode, isAesToStr);},
        rfidUpdateBatch: async (params: rfidUpdateBatchParamType) => {return await mewRequest("/tc/rfid/update/batch", params, "POST", service, isDebugMode, isAesToStr);},
        workorderItemUpdateBatch: async (params: { itemArr: any[] }) => {return await mewRequest("/tc/workorder_item/update/batch", params, "POST", service, isDebugMode, isAesToStr);},
        toolResetData: async (params: any) => {return await mewRequest("/tc/tool/resetData", params, "POST", service, isDebugMode, isAesToStr);},
        workorderLockerOrder: async (params: WorkorderLockerOrderProperty) => {return await mewRequest("/tc/workorder/locker/order", params, "POST", service, isDebugMode, isAesToStr);},
        workorderLockerOrderCancel: async (params: WorkorderLockerOrderCancelProperty) => {return await mewRequest("/tc/workorder/locker/order/cancel", params, "POST", service, isDebugMode, isAesToStr);},
        rfidClassificationStatistics: async (params: {epcArr:string[],deviceId:string}) => {return await mewRequest("/tc/rfid/classificationStatistics", params, "POST", service, isDebugMode, isAesToStr);},
        rfidStatus: async (params: any) => {return await mewRequest("/tc/rfid/getStatus", params, "POST", service, isDebugMode, isAesToStr);},
    }
}
