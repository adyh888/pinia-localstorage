...
export interface DeviceFindAndroidIdProperty {
    androidId: string
}
...
export interface DeviceTypeSelectProperty {
    ...
    type?: string
    image?: string
    initialLongitudeLatitude?: string
    needCleanTime?: boolean
    needCapacity?: boolean
    pageSize?: number
    companyId?: number
    groupId?: number
...
export interface UuidSelectProperty {
    uuid: string;
}

export interface DrawerGenProperty{
    no: number;
    deviceId: string;
    cupboard?: string;
    locationNum?: number;
...
export function Dc(service: any, isDebugMode: boolean = false,isAesToStr = false) {
    return {
        content: new Request<Content, ContentInsertProperty, ContentDeleteProperty, ContentUpdateProperty, ContentSelectProperty>('/dc/content', service, isDebugMode,isAesToStr),
        province: new Request<Province, ProvinceInsertProperty, ProvinceDeleteProperty, ProvinceUpdateProperty, ProvinceSelectProperty>('/dc/province', service, isDebugMode,isAesToStr),
        city: new Request<City, CityInsertProperty, CityDeleteProperty, CityUpdateProperty, CitySelectProperty>('/dc/city', service, isDebugMode,isAesToStr),
        area: new Request<Area, AreaInsertProperty, AreaDeleteProperty, AreaUpdateProperty, AreaSelectProperty>('/dc/area', service, isDebugMode,isAesToStr),
        village: new Request<Village, VillageInsertProperty, VillageDeleteProperty, VillageUpdateProperty, VillageSelectProperty>('/dc/village', service, isDebugMode,isAesToStr),
        building: new Request<Building, BuildingInsertProperty, BuildingDeleteProperty, BuildingUpdateProperty, BuildingSelectProperty>('/dc/building',  service, isDebugMode,isAesToStr),
        family: new Request<Family, FamilyInsertProperty, FamilyDeleteProperty, FamilyUpdateProperty, FamilySelectProperty>('/dc/family', service, isDebugMode,isAesToStr),
        // class
        location: new Request<Location, LocationInsertProperty, LocationDeleteProperty, LocationUpdateProperty, LocationSelectProperty>('/dc/location', service, isDebugMode,isAesToStr),
        group: new Request<Group, GroupInsertProperty, GroupDeleteProperty, GroupUpdateProperty, GroupSelectProperty>('/dc/group', service, isDebugMode,isAesToStr),
        company: new Request<Company, CompanyInsertProperty, CompanyDeleteProperty, CompanyUpdateProperty, CompanySelectProperty>('/dc/company', service, isDebugMode,isAesToStr),
        department: new Request<Department, DepartmentInsertProperty, DepartmentDeleteProperty, DepartmentUpdateProperty, DepartmentSelectProperty>('/dc/department', service, isDebugMode,isAesToStr),
        device: new Request<Device, DeviceInsertProperty, DeviceDeleteProperty, DeviceUpdateProperty, DeviceSelectProperty>('/dc/device', service, isDebugMode,isAesToStr),
        team: new Request<Team, TeamInsertProperty, TeamDeleteProperty, TeamUpdateProperty, TeamSelectProperty>('/dc/team', service, isDebugMode,isAesToStr),
        charger: new Request<Charger, ChargerInsertProperty, ChargerDeleteProperty, ChargerUpdateProperty, ChargerSelectProperty>('/dc/charger', service, isDebugMode,isAesToStr),
        ioAttr: new Request<IoAttr, IoAttrInsertProperty, IoAttrDeleteProperty, IoAttrUpdateProperty, IoAttrSelectProperty>('/dc/ioAttr', service, isDebugMode,isAesToStr),
        io: new Request<Io, IoInsertProperty, IoDeleteProperty, IoUpdateProperty, IoSelectProperty>('/dc/io', service, isDebugMode,isAesToStr),
        io_type: new Request<IoType, IoTypeInsertProperty, IoTypeDeleteProperty, IoTypeUpdateProperty, IoTypeSelectProperty>('/dc/io_type', service, isDebugMode,isAesToStr),
        cabinet: new Request<Cabinet, CabinetInsertProperty, CabinetDeleteProperty, CabinetUpdateProperty, CabinetSelectProperty>('/dc/cabinet', service, isDebugMode,isAesToStr),
        drawer: new Request<Drawer, DrawerInsertProperty, DrawerDeleteProperty, DrawerUpdateProperty, DrawerSelectProperty>('/dc/drawer', service, isDebugMode,isAesToStr),
        verification: new Request<Verification, VerificationInsertProperty, VerificationDeleteProperty, VerificationUpdateProperty, VerificationSelectProperty>('/dc/verification', service, isDebugMode,isAesToStr),
        android: new Request<AndroId, AndroIdInsertProperty, AndroIdDeleteProperty, AndroIdUpdateProperty, AndroIdSelectProperty>('/dc/androId', service, isDebugMode,isAesToStr),
        device_type: new Request<DeviceType, DeviceTypeInsertProperty, DeviceTypeDeleteProperty, DeviceTypeUpdateProperty, DeviceTypeSelectProperty>('/dc/device_type', service, isDebugMode,isAesToStr),
        device_type_company: new Request<DeviceTypeCompany, DeviceTypeCompanyInsertProperty, DeviceTypeCompanyDeleteProperty, DeviceTypeCompanyUpdateProperty, DeviceTypeCompanySelectProperty>('/dc/device_type_company', service, isDebugMode,isAesToStr),
        attributeName: new Request<AttributeName, AttributeNameInsertProperty, AttributeNameDeleteProperty, AttributeNameUpdateProperty, AttributeNameSelectProperty>('/dc/attributeName', service, isDebugMode,isAesToStr),
        // function
        getVersion: () => mewRequest('/dc/select/version', {}, 'POST', service, isDebugMode,isAesToStr),
        deviceSelectChange: (json: DeviceSelectProperty) => mewRequest('/device/list_drawer_id/', json, 'GET', service, isDebugMode,isAesToStr),
        // 代码逻辑过于乱即将废弃
        selectTeamBelong: (json: TeamBelongSelectProperty) => mewRequest('/dc/team/belong/select', json, 'POST', service, isDebugMode,isAesToStr),
        password: (json: VerificationInsertProperty) => mewRequest('/dc/verification/password', json, 'POST', service, isDebugMode,isAesToStr),
        getEmptyCabinet: (json: LocationGetEmptyCabinetProperty) => mewRequest('/dc/location/get_empty_cabinet', json, 'POST', service, isDebugMode,isAesToStr),
        findDeviceByAndroidId: (json: DeviceFindAndroidIdProperty) => mewRequest('/dc/device/find/androidId', json, 'POST', service, isDebugMode,isAesToStr),
        findDeviceByUUID: (json: UuidSelectProperty) => mewRequest('/dc/device/select/uuid', json, 'POST', service, isDebugMode,isAesToStr),
        genCabinetAndDrawerAndTool: (json: DrawerGenProperty) => mewRequest('/dc/drawer/genCabinetAndDrawerAndTool', json, 'POST', service, isDebugMode,isAesToStr),
    }
}
